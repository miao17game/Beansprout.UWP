...
namespace Douban.UWP.NET.Controls {
    public partial class ToastSmooth : UserControl {
        protected Popup DialogPopup;

        protected string TextContent;
        protected TimeSpan WholeTime;

        public static readonly DependencyProperty ToastBackgroundProperty = DependencyProperty.Register("ToastBackground", typeof(Brush), typeof(ToastSmooth), null);
        ...
        public static readonly DependencyProperty ToastForegroundProperty = DependencyProperty.Register("ToastForeground", typeof(Brush), typeof(ToastSmooth), null);
