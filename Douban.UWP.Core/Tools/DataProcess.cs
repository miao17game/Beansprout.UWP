...
namespace Douban.UWP.Core.Tools {
    public static class DataProcess {
        ...
        public  static MovieGroupItem SetGroupItem(JObject jo, JToken sub_collection) {
            return new MovieGroupItem {
        ...
        public static void SetEachSingleton(MovieGroupItem gmodel, JToken singleton) {
            try {
